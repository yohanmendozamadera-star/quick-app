  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogTrigger render={<Button variant="outline" className="gap-1.5" />}>
        ...
        Agregar conciliación masiva
      </DialogTrigger>

      <DialogContent className="flex max-h-[90vh] max-w-3xl flex-col overflow-hidden">
        <DialogHeader>
          <DialogTitle>Carga masiva de conciliaciones</DialogTitle>
          <DialogDescription>
            ...
            {step === "result" && "Resultado de la importación y del cruce automático."}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="flex flex-1 flex-col gap-3 overflow-y-auto">
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <div className="rounded-md border p-3">
                ...
                <p className="text-lg font-semibold text-emerald-700">{result.summary.matched}</p>
              </div>
              <div className="rounded-md border p-3">
                <p className="text-xs text-muted-foreground">Sin coincidencia</p>
                <p className="text-lg font-semibold text-amber-700">
                  {result.summary.created - result.summary.matched}
                </p>
              </div>
            </div>
